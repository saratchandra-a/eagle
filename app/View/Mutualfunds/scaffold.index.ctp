<div class="mutualfunds index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('52WHigh'); ?></th>
			<th><?php echo $this->Paginator->sort('52WLow'); ?></th>
			<th><?php echo $this->Paginator->sort('tradevolume'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($mutualfund['Mutualfund']['52WHigh']); ?>&nbsp;</td>
		<td><?php echo h($mutualfund['Mutualfund']['52WLow']); ?>&nbsp;</td>
		<td><?php echo h($mutualfund['Mutualfund']['tradevolume']); ?>&nbsp;</td>
		<td><?php echo h($mutualfund['Mutualfund']['High']); ?>&nbsp;</td>
		<td><?php echo h($mutualfund['Mutualfund']['Low']); ?>&nbsp;</td>
		<td><?php echo h($mutualfund['Mutualfund']['created']); ?>&nbsp;</td>
		<td><?php echo h($mutualfund['Mutualfund']['modified']); ?>&nbsp;</td>
		<td class="actions">
